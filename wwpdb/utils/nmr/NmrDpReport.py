...
# 09-Apr-2025  M. Yokochi - add 'nm-shi-ari', 'nm-shi-bar', 'nm-shi-gar', 'nm-shi-ppm', and 'nm-shi-xea' file_type for standalone NMR data conversion service (v4.4.0, DAOTHER-9785)
##
...
class NmrDpReportInputSource:
    ...
    def __init__(self, verbose: bool = True, log: IO = sys.stdout):
        ...
        self.file_types = ('pdbx',
                           ...
                           'nm-shi-ari', 'nm-shi-bar', 'nm-shi-gar', 'nm-shi-ppm', 'nm-shi-xea')
