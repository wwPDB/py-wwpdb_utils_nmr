...
class NmrDpUtility:
                ...
                for ps1 in poly_seq:
                    ...
                    for _poly_seq_in_lp in poly_seq_in_lp[content_subtype]:
                        ...
                        for ps2 in poly_seq2:
                            ...
                            seq_align = {'list_id': _poly_seq_in_lp['list_id'], 'sf_framecode': sf_framecode2, 'chain_id': chain_id, 'length': ref_length,
    ...
    def __updatePolymerSequence(self) -> bool:
        ...
        paramag = len(chem_comp) > 0 and any(True for cc in chem_comp if cc['type'] == 'non-poly' and cc['id'] in PARAMAGNETIC_ELEMENTS)
