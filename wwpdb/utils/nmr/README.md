...
nmr-if-merge-deposit|Merge NMR metadata (aka. NMRIF) to NMR-STAR file on OneDep submission.
...
------------|--------------|----------------------------|-----------
nmr-star|nm-shi<br/>or nm-uni-str|nmr&#8209;chemical&#8209;shifts&nbsp;/&nbsp;(nmr&#8209;star&nbsp;\|&nbsp;pdbx)<br/>or nmr-data-str&nbsp;/&nbsp;(nmr&#8209;star&nbsp;\|&nbsp;pdbx)|NMR data file in NMR-STAR format
nef|nm-uni-nef|nmr-data-nef / (nmr-star \| pdbx)|NMR data file in NEF (NMR Exchange Format)
...
nmrif|**not applicable**|(nmrif \| model) / pdbx|NMR metadata file in PDBx/mmCIF format (aka. NMRIF)
