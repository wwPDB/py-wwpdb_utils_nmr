...
`merge_any_pk_as_is`|`param`|Boolean value. True until NMR data remediation (Phase 2). **Deprecated.**
...
`nm-aux-xea`|`nm-pea-any`|`nmr-peaks` / `any`|Assignment file in XEASY format
