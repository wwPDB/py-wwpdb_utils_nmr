...
nmrif_file_path|file|Set CIF formatted NMRIF/NMR-STAR metadata file path. NOTE: used only for OneDep workflow ('nmr-if-merge-merge-deposit')
...
nmr-if-merge-deposit|Merge NMRIF metadata to NMR-STAR file on OneDep submission.
