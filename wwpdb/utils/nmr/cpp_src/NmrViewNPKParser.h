...
class  NmrViewNPKParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleNmrview_npk = 0, RuleData_label = 1, RuleLabels = 2, RulePeak_list_2d = 3, 
  ...
  explicit NmrViewNPKParser(antlr4::TokenStream *input);

  NmrViewNPKParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~NmrViewNPKParser() override;
  ...
  class  Nmrview_npkContext : public antlr4::ParserRuleContext {
  public:
    Nmrview_npkContext(antlr4::ParserRuleContext *parent, size_t invokingState);
  ...
  Nmrview_npkContext* nmrview_npk();
