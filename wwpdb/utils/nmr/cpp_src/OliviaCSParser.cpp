...
// Generated from /data/git/py-wwpdb_utils_nmr/wwpdb/utils/tests-nmr/antlr-grammars-v4.10/OliviaCSParser.g4 by ANTLR 4.13.2
...
static thread_local
#endif
std::unique_ptr<OliviaCSParserStaticData> oliviacsparserParserStaticData = nullptr;
...
void oliviacsparserParserInitialize() {
  ...
  oliviacsparserParserStaticData = std::move(staticData);
}
