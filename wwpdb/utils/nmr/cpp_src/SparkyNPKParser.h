...
class  SparkyNPKParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleSparky_npk = 0, RuleData_label = 1, RulePeak_2d = 2, RulePeak_3d = 3, 
    RulePeak_4d = 4, RulePeak_2d_po = 5, RulePeak_3d_po = 6, RulePeak_4d_po = 7, 
    RuleNumber = 8, RuleNote = 9
  };

  explicit SparkyNPKParser(antlr4::TokenStream *input);

  SparkyNPKParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~SparkyNPKParser() override;
  ...
  class Sparky_npkContext;
  class Data_labelContext;
  class Peak_2dContext;
  class Peak_3dContext;
  class Peak_4dContext;
  class Peak_2d_poContext;
  class Peak_3d_poContext;
  class Peak_4d_poContext;
  class NumberContext;
  class NoteContext; 

  class  Sparky_npkContext : public antlr4::ParserRuleContext {
  public:
    Sparky_npkContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    ...
    std::vector<Peak_2d_poContext *> peak_2d_po();
    Peak_2d_poContext* peak_2d_po(size_t i);
    std::vector<Peak_3d_poContext *> peak_3d_po();
    Peak_3d_poContext* peak_3d_po(size_t i);
    std::vector<Peak_4d_poContext *> peak_4d_po();
    Peak_4d_poContext* peak_4d_po(size_t i);
  ...
  public:
    ...
    std::vector<antlr4::tree::TerminalNode *> Height_LA();
    antlr4::tree::TerminalNode* Height_LA(size_t i);
    std::vector<antlr4::tree::TerminalNode *> Volume_LA();
    antlr4::tree::TerminalNode* Volume_LA(size_t i);
    ...
    std::vector<antlr4::tree::TerminalNode *> Dummy_H_LA();
    antlr4::tree::TerminalNode* Dummy_H_LA(size_t i);
  ...
  class  Peak_2d_poContext : public antlr4::ParserRuleContext {
  public:
    Peak_2d_poContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<antlr4::tree::TerminalNode *> Float();
    antlr4::tree::TerminalNode* Float(size_t i);
    antlr4::tree::TerminalNode *Assignment_2d_ex();
  ...
  Peak_2d_poContext* peak_2d_po();

  class  Peak_3d_poContext : public antlr4::ParserRuleContext {
  public:
    Peak_3d_poContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<antlr4::tree::TerminalNode *> Float();
    antlr4::tree::TerminalNode* Float(size_t i);
    antlr4::tree::TerminalNode *Assignment_3d_ex();
  ...
  Peak_3d_poContext* peak_3d_po();

  class  Peak_4d_poContext : public antlr4::ParserRuleContext {
  public:
    Peak_4d_poContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *Assignment_4d_ex();
    std::vector<antlr4::tree::TerminalNode *> Float();
    antlr4::tree::TerminalNode* Float(size_t i);
