...
// Generated from /data/git/py-wwpdb_utils_nmr/wwpdb/utils/tests-nmr/antlr-grammars-v4.10/XwinNmrPKParser.g4 by ANTLR 4.13.2
...
static thread_local
#endif
std::unique_ptr<XwinNmrPKParserStaticData> xwinnmrpkparserParserStaticData = nullptr;
...
void xwinnmrpkparserParserInitialize() {
  ...
  xwinnmrpkparserParserStaticData = std::move(staticData);
}
