...
#include "AmberMRLexer.h"
#include "AmberMRParser.h"
#include "speedy_antlr.h"

#include "sa_ambermr_translator.h"
antlr4::tree::ParseTree* get_parse_tree_amber_mr(AmberMRParser *parser) {return parser->amber_mr();}

antlr4::tree::ParseTree* get_parse_tree(AmberMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(AmberMRParser*)> table
    {
        {"amber_mr", &get_parse_tree_amber_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        AmberMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_AmberMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_ambermr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_ambermr_cpp_parser(void) {
