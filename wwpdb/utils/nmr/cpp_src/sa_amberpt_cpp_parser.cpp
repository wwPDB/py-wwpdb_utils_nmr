...
#include "AmberPTLexer.h"
#include "AmberPTParser.h"
#include "speedy_antlr.h"

#include "sa_amberpt_translator.h"
antlr4::tree::ParseTree* get_parse_tree_amber_pt(AmberPTParser *parser) {return parser->amber_pt();}

antlr4::tree::ParseTree* get_parse_tree(AmberPTParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(AmberPTParser*)> table
    {
        {"amber_pt", &get_parse_tree_amber_pt}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        AmberPTParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_AmberPTTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_amberpt_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_amberpt_cpp_parser(void) {
