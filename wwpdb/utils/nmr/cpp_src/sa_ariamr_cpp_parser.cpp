...
antlr4::tree::ParseTree* get_parse_tree_aria_mr(AriaMRParser *parser) {return parser->aria_mr();}

antlr4::tree::ParseTree* get_parse_tree(AriaMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(AriaMRParser*)> table
    {
        {"aria_mr", &get_parse_tree_aria_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        AriaMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_AriaMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_ariamr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_ariamr_cpp_parser(void) {
