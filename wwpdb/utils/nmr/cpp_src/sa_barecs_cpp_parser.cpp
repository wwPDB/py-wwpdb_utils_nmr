...
antlr4::tree::ParseTree* get_parse_tree_bare_cs(BareCSParser *parser) {return parser->bare_cs();}

antlr4::tree::ParseTree* get_parse_tree(BareCSParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(BareCSParser*)> table
    {
        {"bare_cs", &get_parse_tree_bare_cs}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        BareCSParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_BareCSTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_barecs_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_barecs_cpp_parser(void) {
