...
antlr4::tree::ParseTree* get_parse_tree_bare_mr(BareMRParser *parser) {return parser->bare_mr();}

antlr4::tree::ParseTree* get_parse_tree(BareMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(BareMRParser*)> table
    {
        {"bare_mr", &get_parse_tree_bare_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        BareMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_BareMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_baremr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_baremr_cpp_parser(void) {
