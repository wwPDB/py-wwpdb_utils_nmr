...
#include "BarePDBLexer.h"
#include "BarePDBParser.h"
#include "speedy_antlr.h"

#include "sa_barepdb_translator.h"
antlr4::tree::ParseTree* get_parse_tree_bare_pdb(BarePDBParser *parser) {return parser->bare_pdb();}

antlr4::tree::ParseTree* get_parse_tree(BarePDBParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(BarePDBParser*)> table
    {
        {"bare_pdb", &get_parse_tree_bare_pdb}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        BarePDBParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_BarePDBTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_barepdb_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_barepdb_cpp_parser(void) {
