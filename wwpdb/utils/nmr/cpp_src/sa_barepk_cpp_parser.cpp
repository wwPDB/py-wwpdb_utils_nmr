...
antlr4::tree::ParseTree* get_parse_tree_bare_pk(BarePKParser *parser) {return parser->bare_pk();}

antlr4::tree::ParseTree* get_parse_tree(BarePKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(BarePKParser*)> table
    {
        {"bare_pk", &get_parse_tree_bare_pk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        BarePKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_BarePKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_barepk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_barepk_cpp_parser(void) {
