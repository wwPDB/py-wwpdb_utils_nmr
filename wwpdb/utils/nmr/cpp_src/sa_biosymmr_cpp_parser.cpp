...
antlr4::tree::ParseTree* get_parse_tree_biosym_mr(BiosymMRParser *parser) {return parser->biosym_mr();}

antlr4::tree::ParseTree* get_parse_tree(BiosymMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(BiosymMRParser*)> table
    {
        {"biosym_mr", &get_parse_tree_biosym_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        BiosymMRLexer lexer(&cpp_stream);
        ...
        // Parse
        BiosymMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_BiosymMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_biosymmr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_biosymmr_cpp_parser(void) {
