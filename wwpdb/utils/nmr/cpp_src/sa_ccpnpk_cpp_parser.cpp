...
antlr4::tree::ParseTree* get_parse_tree_ccpn_pk(CcpnPKParser *parser) {return parser->ccpn_pk();}

antlr4::tree::ParseTree* get_parse_tree(CcpnPKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(CcpnPKParser*)> table
    {
        {"ccpn_pk", &get_parse_tree_ccpn_pk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        CcpnPKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_CcpnPKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_ccpnpk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_ccpnpk_cpp_parser(void) {
