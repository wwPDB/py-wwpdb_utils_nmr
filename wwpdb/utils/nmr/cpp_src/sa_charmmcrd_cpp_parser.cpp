...
antlr4::tree::ParseTree* get_parse_tree_charmm_crd(CharmmCRDParser *parser) {return parser->charmm_crd();}

antlr4::tree::ParseTree* get_parse_tree(CharmmCRDParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(CharmmCRDParser*)> table
    {
        {"charmm_crd", &get_parse_tree_charmm_crd}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        CharmmCRDLexer lexer(&cpp_stream);
        ...
        // Parse
        CharmmCRDParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_CharmmCRDTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_charmmcrd_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_charmmcrd_cpp_parser(void) {
