...
antlr4::tree::ParseTree* get_parse_tree_charmm_mr(CharmmMRParser *parser) {return parser->charmm_mr();}

antlr4::tree::ParseTree* get_parse_tree(CharmmMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(CharmmMRParser*)> table
    {
        {"charmm_mr", &get_parse_tree_charmm_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        CharmmMRLexer lexer(&cpp_stream);
        ...
        // Parse
        CharmmMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_CharmmMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_charmmmr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_charmmmr_cpp_parser(void) {
