...
#include "CnsMRLexer.h"
#include "CnsMRParser.h"
#include "speedy_antlr.h"

#include "sa_cnsmr_translator.h"
antlr4::tree::ParseTree* get_parse_tree_cns_mr(CnsMRParser *parser) {return parser->cns_mr();}

antlr4::tree::ParseTree* get_parse_tree(CnsMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(CnsMRParser*)> table
    {
        {"cns_mr", &get_parse_tree_cns_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        CnsMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_CnsMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_cnsmr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_cnsmr_cpp_parser(void) {
