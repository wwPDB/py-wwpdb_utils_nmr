...
antlr4::tree::ParseTree* get_parse_tree_cyana_mr(CyanaMRParser *parser) {return parser->cyana_mr();}

antlr4::tree::ParseTree* get_parse_tree(CyanaMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(CyanaMRParser*)> table
    {
        {"cyana_mr", &get_parse_tree_cyana_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        CyanaMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_CyanaMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_cyanamr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_cyanamr_cpp_parser(void) {
