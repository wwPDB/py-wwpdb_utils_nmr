...
#include "CyanaNOALexer.h"
#include "CyanaNOAParser.h"
#include "speedy_antlr.h"

#include "sa_cyananoa_translator.h"
antlr4::tree::ParseTree* get_parse_tree_cyana_noa(CyanaNOAParser *parser) {return parser->cyana_noa();}

antlr4::tree::ParseTree* get_parse_tree(CyanaNOAParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(CyanaNOAParser*)> table
    {
        {"cyana_noa", &get_parse_tree_cyana_noa}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        CyanaNOALexer lexer(&cpp_stream);
        ...
        // Parse
        CyanaNOAParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_CyanaNOATranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_cyananoa_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_cyananoa_cpp_parser(void) {
