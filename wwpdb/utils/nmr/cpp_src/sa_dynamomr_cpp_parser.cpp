...
#include "DynamoMRLexer.h"
#include "DynamoMRParser.h"
#include "speedy_antlr.h"

#include "sa_dynamomr_translator.h"
antlr4::tree::ParseTree* get_parse_tree_dynamo_mr(DynamoMRParser *parser) {return parser->dynamo_mr();}

antlr4::tree::ParseTree* get_parse_tree(DynamoMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(DynamoMRParser*)> table
    {
        {"dynamo_mr", &get_parse_tree_dynamo_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        DynamoMRLexer lexer(&cpp_stream);
        ...
        // Parse
        DynamoMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_DynamoMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_dynamomr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_dynamomr_cpp_parser(void) {
