...
antlr4::tree::ParseTree* get_parse_tree_garret_cs(GarretCSParser *parser) {return parser->garret_cs();}

antlr4::tree::ParseTree* get_parse_tree(GarretCSParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(GarretCSParser*)> table
    {
        {"garret_cs", &get_parse_tree_garret_cs}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        GarretCSLexer lexer(&cpp_stream);
        ...
        // Parse
        GarretCSParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_GarretCSTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_garretcs_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_garretcs_cpp_parser(void) {
