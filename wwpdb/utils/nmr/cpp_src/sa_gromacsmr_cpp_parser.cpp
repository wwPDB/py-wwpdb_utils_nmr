...
antlr4::tree::ParseTree* get_parse_tree_gromacs_mr(GromacsMRParser *parser) {return parser->gromacs_mr();}

antlr4::tree::ParseTree* get_parse_tree(GromacsMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(GromacsMRParser*)> table
    {
        {"gromacs_mr", &get_parse_tree_gromacs_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        GromacsMRLexer lexer(&cpp_stream);
        ...
        // Parse
        GromacsMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_GromacsMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_gromacsmr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_gromacsmr_cpp_parser(void) {
