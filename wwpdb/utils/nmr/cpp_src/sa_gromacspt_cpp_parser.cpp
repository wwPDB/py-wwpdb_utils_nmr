...
#include "GromacsPTLexer.h"
#include "GromacsPTParser.h"
#include "speedy_antlr.h"

#include "sa_gromacspt_translator.h"
antlr4::tree::ParseTree* get_parse_tree_gromacs_pt(GromacsPTParser *parser) {return parser->gromacs_pt();}

antlr4::tree::ParseTree* get_parse_tree(GromacsPTParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(GromacsPTParser*)> table
    {
        {"gromacs_pt", &get_parse_tree_gromacs_pt}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        GromacsPTLexer lexer(&cpp_stream);
        ...
        // Parse
        GromacsPTParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_GromacsPTTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_gromacspt_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_gromacspt_cpp_parser(void) {
