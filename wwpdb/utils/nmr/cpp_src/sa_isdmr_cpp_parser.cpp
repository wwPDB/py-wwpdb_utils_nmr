...
antlr4::tree::ParseTree* get_parse_tree_isd_mr(IsdMRParser *parser) {return parser->isd_mr();}

antlr4::tree::ParseTree* get_parse_tree(IsdMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(IsdMRParser*)> table
    {
        {"isd_mr", &get_parse_tree_isd_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        IsdMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_IsdMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_isdmr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_isdmr_cpp_parser(void) {
