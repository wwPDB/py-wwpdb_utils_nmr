...
#include "NmrPipeCSLexer.h"
#include "NmrPipeCSParser.h"
#include "speedy_antlr.h"

#include "sa_nmrpipecs_translator.h"
antlr4::tree::ParseTree* get_parse_tree_nmrpipe_cs(NmrPipeCSParser *parser) {return parser->nmrpipe_cs();}

antlr4::tree::ParseTree* get_parse_tree(NmrPipeCSParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(NmrPipeCSParser*)> table
    {
        {"nmrpipe_cs", &get_parse_tree_nmrpipe_cs}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        NmrPipeCSLexer lexer(&cpp_stream);
        ...
        // Parse
        NmrPipeCSParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_NmrPipeCSTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_nmrpipecs_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_nmrpipecs_cpp_parser(void) {
