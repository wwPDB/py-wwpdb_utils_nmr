...
#include "NmrPipePKLexer.h"
#include "NmrPipePKParser.h"
#include "speedy_antlr.h"

#include "sa_nmrpipepk_translator.h"
antlr4::tree::ParseTree* get_parse_tree_nmrpipe_pk(NmrPipePKParser *parser) {return parser->nmrpipe_pk();}

antlr4::tree::ParseTree* get_parse_tree(NmrPipePKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(NmrPipePKParser*)> table
    {
        {"nmrpipe_pk", &get_parse_tree_nmrpipe_pk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        NmrPipePKLexer lexer(&cpp_stream);
        ...
        // Parse
        NmrPipePKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_NmrPipePKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_nmrpipepk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_nmrpipepk_cpp_parser(void) {
