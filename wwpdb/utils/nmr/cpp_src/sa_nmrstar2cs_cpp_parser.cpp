...
antlr4::tree::ParseTree* get_parse_tree_nmrstar2_cs(NmrStar2CSParser *parser) {return parser->nmrstar2_cs();}

antlr4::tree::ParseTree* get_parse_tree(NmrStar2CSParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(NmrStar2CSParser*)> table
    {
        {"nmrstar2_cs", &get_parse_tree_nmrstar2_cs}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        NmrStar2CSLexer lexer(&cpp_stream);
        ...
        // Parse
        NmrStar2CSParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_NmrStar2CSTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_nmrstar2cs_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_nmrstar2cs_cpp_parser(void) {
