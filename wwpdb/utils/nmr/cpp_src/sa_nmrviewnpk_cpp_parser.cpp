...
antlr4::tree::ParseTree* get_parse_tree_nmrview_npk(NmrViewNPKParser *parser) {return parser->nmrview_npk();}

antlr4::tree::ParseTree* get_parse_tree(NmrViewNPKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(NmrViewNPKParser*)> table
    {
        {"nmrview_npk", &get_parse_tree_nmrview_npk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        NmrViewPKLexer lexer(&cpp_stream);
        ...
        // Parse
        NmrViewNPKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_NmrViewNPKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_nmrviewnpk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_nmrviewnpk_cpp_parser(void) {
