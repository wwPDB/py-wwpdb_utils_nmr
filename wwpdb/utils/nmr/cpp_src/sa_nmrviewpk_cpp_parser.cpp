...
antlr4::tree::ParseTree* get_parse_tree_nmrview_pk(NmrViewPKParser *parser) {return parser->nmrview_pk();}

antlr4::tree::ParseTree* get_parse_tree(NmrViewPKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(NmrViewPKParser*)> table
    {
        {"nmrview_pk", &get_parse_tree_nmrview_pk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        NmrViewPKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_NmrViewPKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_nmrviewpk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_nmrviewpk_cpp_parser(void) {
