...
antlr4::tree::ParseTree* get_parse_tree_olivia_cs(OliviaCSParser *parser) {return parser->olivia_cs();}

antlr4::tree::ParseTree* get_parse_tree(OliviaCSParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(OliviaCSParser*)> table
    {
        {"olivia_cs", &get_parse_tree_olivia_cs}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        OliviaCSLexer lexer(&cpp_stream);
        ...
        // Parse
        OliviaCSParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_OliviaCSTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_oliviacs_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_oliviacs_cpp_parser(void) {
