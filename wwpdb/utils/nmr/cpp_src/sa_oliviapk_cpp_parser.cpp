...
antlr4::tree::ParseTree* get_parse_tree_olivia_pk(OliviaPKParser *parser) {return parser->olivia_pk();}

antlr4::tree::ParseTree* get_parse_tree(OliviaPKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(OliviaPKParser*)> table
    {
        {"olivia_pk", &get_parse_tree_olivia_pk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        OliviaPKLexer lexer(&cpp_stream);
        ...
        // Parse
        OliviaPKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_OliviaPKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_oliviapk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_oliviapk_cpp_parser(void) {
