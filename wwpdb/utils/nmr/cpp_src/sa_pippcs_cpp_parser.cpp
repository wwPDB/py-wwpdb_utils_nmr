...
antlr4::tree::ParseTree* get_parse_tree_pipp_cs(PippCSParser *parser) {return parser->pipp_cs();}

antlr4::tree::ParseTree* get_parse_tree(PippCSParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(PippCSParser*)> table
    {
        {"pipp_cs", &get_parse_tree_pipp_cs}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        PippCSParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_PippCSTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_pippcs_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_pippcs_cpp_parser(void) {
