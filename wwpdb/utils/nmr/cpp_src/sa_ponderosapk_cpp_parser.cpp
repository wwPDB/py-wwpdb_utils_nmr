...
antlr4::tree::ParseTree* get_parse_tree_ponderosa_pk(PonderosaPKParser *parser) {return parser->ponderosa_pk();}

antlr4::tree::ParseTree* get_parse_tree(PonderosaPKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(PonderosaPKParser*)> table
    {
        {"ponderosa_pk", &get_parse_tree_ponderosa_pk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        PonderosaPKLexer lexer(&cpp_stream);
        ...
        // Parse
        PonderosaPKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_PonderosaPKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_ponderosapk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_ponderosapk_cpp_parser(void) {
