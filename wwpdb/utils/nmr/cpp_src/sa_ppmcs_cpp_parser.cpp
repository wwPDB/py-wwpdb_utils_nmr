...
antlr4::tree::ParseTree* get_parse_tree_ppm_cs(PpmCSParser *parser) {return parser->ppm_cs();}

antlr4::tree::ParseTree* get_parse_tree(PpmCSParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(PpmCSParser*)> table
    {
        {"ppm_cs", &get_parse_tree_ppm_cs}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        PpmCSParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_PpmCSTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_ppmcs_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_ppmcs_cpp_parser(void) {
