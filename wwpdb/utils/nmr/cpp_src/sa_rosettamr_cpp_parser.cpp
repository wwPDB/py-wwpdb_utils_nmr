...
antlr4::tree::ParseTree* get_parse_tree_rosetta_mr(RosettaMRParser *parser) {return parser->rosetta_mr();}

antlr4::tree::ParseTree* get_parse_tree(RosettaMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(RosettaMRParser*)> table
    {
        {"rosetta_mr", &get_parse_tree_rosetta_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        RosettaMRLexer lexer(&cpp_stream);
        ...
        // Parse
        RosettaMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_RosettaMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_rosettamr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_rosettamr_cpp_parser(void) {
