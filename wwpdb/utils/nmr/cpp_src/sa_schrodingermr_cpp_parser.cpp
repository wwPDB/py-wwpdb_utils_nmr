...
#include "SchrodingerMRLexer.h"
#include "SchrodingerMRParser.h"
#include "speedy_antlr.h"

#include "sa_schrodingermr_translator.h"
antlr4::tree::ParseTree* get_parse_tree_schrodinger_mr(SchrodingerMRParser *parser) {return parser->schrodinger_mr();}

antlr4::tree::ParseTree* get_parse_tree(SchrodingerMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(SchrodingerMRParser*)> table
    {
        {"schrodinger_mr", &get_parse_tree_schrodinger_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        SchrodingerMRLexer lexer(&cpp_stream);
        ...
        // Parse
        SchrodingerMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_SchrodingerMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_schrodingermr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_schrodingermr_cpp_parser(void) {
