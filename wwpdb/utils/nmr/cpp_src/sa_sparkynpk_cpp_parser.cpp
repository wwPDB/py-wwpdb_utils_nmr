...
antlr4::tree::ParseTree* get_parse_tree_sparky_npk(SparkyNPKParser *parser) {return parser->sparky_npk();}

antlr4::tree::ParseTree* get_parse_tree(SparkyNPKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(SparkyNPKParser*)> table
    {
        {"sparky_npk", &get_parse_tree_sparky_npk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        SparkyNPKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_SparkyNPKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_sparkynpk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_sparkynpk_cpp_parser(void) {
