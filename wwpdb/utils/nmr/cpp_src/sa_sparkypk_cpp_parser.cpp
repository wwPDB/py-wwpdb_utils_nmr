...
antlr4::tree::ParseTree* get_parse_tree_sparky_pk(SparkyPKParser *parser) {return parser->sparky_pk();}

antlr4::tree::ParseTree* get_parse_tree(SparkyPKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(SparkyPKParser*)> table
    {
        {"sparky_pk", &get_parse_tree_sparky_pk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        SparkyPKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_SparkyPKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_sparkypk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_sparkypk_cpp_parser(void) {
