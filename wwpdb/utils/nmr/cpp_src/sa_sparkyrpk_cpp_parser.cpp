...
#include "SparkyPKLexer.h"
#include "SparkyRPKParser.h"
#include "speedy_antlr.h"

#include "sa_sparkyrpk_translator.h"
antlr4::tree::ParseTree* get_parse_tree_sparky_rpk(SparkyRPKParser *parser) {return parser->sparky_rpk();}

antlr4::tree::ParseTree* get_parse_tree(SparkyRPKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(SparkyRPKParser*)> table
    {
        {"sparky_rpk", &get_parse_tree_sparky_rpk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        SparkyPKLexer lexer(&cpp_stream);
        ...
        // Parse
        SparkyRPKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_SparkyRPKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_sparkyrpk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_sparkyrpk_cpp_parser(void) {
