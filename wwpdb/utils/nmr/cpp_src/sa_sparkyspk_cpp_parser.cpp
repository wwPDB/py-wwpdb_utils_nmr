...
#include "SparkySPKLexer.h"
#include "SparkySPKParser.h"
#include "speedy_antlr.h"

#include "sa_sparkyspk_translator.h"
antlr4::tree::ParseTree* get_parse_tree_sparky_spk(SparkySPKParser *parser) {return parser->sparky_spk();}

antlr4::tree::ParseTree* get_parse_tree(SparkySPKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(SparkySPKParser*)> table
    {
        {"sparky_spk", &get_parse_tree_sparky_spk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        SparkySPKLexer lexer(&cpp_stream);
        ...
        // Parse
        SparkySPKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_SparkySPKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_sparkyspk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_sparkyspk_cpp_parser(void) {
