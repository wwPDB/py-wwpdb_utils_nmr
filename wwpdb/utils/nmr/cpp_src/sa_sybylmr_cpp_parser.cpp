...
antlr4::tree::ParseTree* get_parse_tree(SybylMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(SybylMRParser*)> table
    {
        {"sybyl_mr", &get_parse_tree_sybyl_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        SybylMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_SybylMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_sybylmr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_sybylmr_cpp_parser(void) {
