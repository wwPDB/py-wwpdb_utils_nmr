...
#include "VnmrPKLexer.h"
#include "VnmrPKParser.h"
#include "speedy_antlr.h"

#include "sa_vnmrpk_translator.h"
antlr4::tree::ParseTree* get_parse_tree_vnmr_pk(VnmrPKParser *parser) {return parser->vnmr_pk();}

antlr4::tree::ParseTree* get_parse_tree(VnmrPKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(VnmrPKParser*)> table
    {
        {"vnmr_pk", &get_parse_tree_vnmr_pk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        VnmrPKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_VnmrPKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_vnmrpk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_vnmrpk_cpp_parser(void) {
