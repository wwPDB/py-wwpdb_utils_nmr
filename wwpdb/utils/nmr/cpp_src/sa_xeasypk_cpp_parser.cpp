...
antlr4::tree::ParseTree* get_parse_tree_xeasy_pk(XeasyPKParser *parser) {return parser->xeasy_pk();}

antlr4::tree::ParseTree* get_parse_tree(XeasyPKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(XeasyPKParser*)> table
    {
        {"xeasy_pk", &get_parse_tree_xeasy_pk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        XeasyPKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_XeasyPKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_xeasypk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_xeasypk_cpp_parser(void) {
