...
antlr4::tree::ParseTree* get_parse_tree_xeasy_prot(XeasyPROTParser *parser) {return parser->xeasy_prot();}

antlr4::tree::ParseTree* get_parse_tree(XeasyPROTParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(XeasyPROTParser*)> table
    {
        {"xeasy_prot", &get_parse_tree_xeasy_prot}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        XeasyPROTLexer lexer(&cpp_stream);
        ...
        // Parse
        XeasyPROTParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_XeasyPROTTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_xeasyprot_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_xeasyprot_cpp_parser(void) {
