...
antlr4::tree::ParseTree* get_parse_tree_document(XMLParser *parser) {return parser->document();}

antlr4::tree::ParseTree* get_parse_tree(XMLParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(XMLParser*)> table
    {
        {"document", &get_parse_tree_document}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        SA_XMLTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_xml_cpp_parser",   /* name of module */
