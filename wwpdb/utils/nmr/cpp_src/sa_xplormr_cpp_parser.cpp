...
antlr4::tree::ParseTree* get_parse_tree_xplor_nih_mr(XplorMRParser *parser) {return parser->xplor_nih_mr();}

antlr4::tree::ParseTree* get_parse_tree(XplorMRParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(XplorMRParser*)> table
    {
        {"xplor_nih_mr", &get_parse_tree_xplor_nih_mr}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        XplorMRParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_XplorMRTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_xplormr_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_xplormr_cpp_parser(void) {
