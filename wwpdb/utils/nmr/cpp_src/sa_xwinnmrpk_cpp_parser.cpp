...
antlr4::tree::ParseTree* get_parse_tree_xwinnmr_pk(XwinNmrPKParser *parser) {return parser->xwinnmr_pk();}

antlr4::tree::ParseTree* get_parse_tree(XwinNmrPKParser *parser, const char *entry_rule_name) {
    static std::map<std::string, antlr4::tree::ParseTree* (*)(XwinNmrPKParser*)> table
    {
        {"xwinnmr_pk", &get_parse_tree_xwinnmr_pk}
    };
...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Lex
        XwinNmrPKLexer lexer(&cpp_stream);
        ...
        // Parse
        XwinNmrPKParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_XwinNmrPKTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_xwinnmrpk_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_xwinnmrpk_cpp_parser(void) {
