...
class BareCSParser ( Parser ):
    ...
    RULE_bare_cs = 0
    RULE_cs_row_format = 1
    RULE_header = 2
    RULE_cs_row_list = 3
    RULE_any = 4
    RULE_column_name = 5

    ruleNames =  [ "bare_cs", "cs_row_format", "header", "cs_row_list", 
                   "any", "column_name" ]
    ...
    class Bare_csContext(ParserRuleContext):
        ...
        def cs_row_format(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(BareCSParser.Cs_row_formatContext)
            else:
                return self.getTypedRuleContext(BareCSParser.Cs_row_formatContext,i)
    ...
    class Cs_row_formatContext(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def header(self):
            return self.getTypedRuleContext(BareCSParser.HeaderContext,0)


        def cs_row_list(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(BareCSParser.Cs_row_listContext)
            else:
                return self.getTypedRuleContext(BareCSParser.Cs_row_listContext,i)


        def getRuleIndex(self):
            return BareCSParser.RULE_cs_row_format

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterCs_row_format" ):
                listener.enterCs_row_format(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitCs_row_format" ):
                listener.exitCs_row_format(self)




    def cs_row_format(self):

        localctx = BareCSParser.Cs_row_formatContext(self, self._ctx, self.state)
        self.enterRule(localctx, 2, self.RULE_cs_row_format)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 24
            self.header()
    ...
    class HeaderContext(ParserRuleContext):
        ...
        def column_name(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(BareCSParser.Column_nameContext)
            else:
                return self.getTypedRuleContext(BareCSParser.Column_nameContext,i)


        def getRuleIndex(self):
            return BareCSParser.RULE_header
    ...
    def header(self):
        ...
        localctx = BareCSParser.HeaderContext(self, self._ctx, self.state)
    ...
    class Cs_row_listContext(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def getRuleIndex(self):
            return BareCSParser.RULE_cs_row_list

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterCs_row_list" ):
                listener.enterCs_row_list(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitCs_row_list" ):
                listener.exitCs_row_list(self)




    def cs_row_list(self):

        localctx = BareCSParser.Cs_row_listContext(self, self._ctx, self.state)
        self.enterRule(localctx, 6, self.RULE_cs_row_list)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 38 
    ...
    class Column_nameContext(ParserRuleContext):
        ...
        def Number_of_name(self):
            return self.getToken(BareCSParser.Number_of_name, 0)

        def getRuleIndex(self):
            return BareCSParser.RULE_column_name
    ...
    def column_name(self):
        ...
        localctx = BareCSParser.Column_nameContext(self, self._ctx, self.state)
