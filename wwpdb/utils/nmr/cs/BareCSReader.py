...
try:
    ...
    from wwpdb.utils.nmr.cs import sa_barecs
    ...
    def parse(self, csFilePath: str, isFilePath: bool = True,
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(BareCSLexer, BareCSParser, 'bare_cs', csText,
                           filePath=csFilePath, saModule=sa_barecs,
            ...
            listener = BareCSParserListener(self.__verbose, self.__log,
