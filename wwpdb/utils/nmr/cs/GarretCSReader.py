...
# Update:
##
""" A collection of classes for parsing GARRET CS files.
"""
...
try:
    ...
    from wwpdb.utils.nmr.cs import sa_garretcs
    ...
    from wwpdb.utils.nmr.cs.GarretCSParserListener import GarretCSParserListener
except ImportError:
    ...
    from nmr.cs import sa_garretcs
    from nmr.mr.LexerErrorListener import LexerErrorListener
    from nmr.mr.ParserErrorListener import ParserErrorListener
    from nmr.cs.GarretCSLexer import GarretCSLexer
    from nmr.cs.GarretCSParser import GarretCSParser
    from nmr.cs.GarretCSParserListener import GarretCSParserListener


class GarretCSReader:
    """ Accessor methods for parsing GARRET CS files.
    """
    ...
    def parse(self, csFilePath: str, isFilePath: bool = True,
              ...
              ) -> Tuple[Optional[GarretCSParserListener], Optional[ParserErrorListener], Optional[LexerErrorListener]]:
        """ Parse GARRET CS file.
            @return: GarretCSParserListener for success or None otherwise, ParserErrorListener, LexerErrorListener.
        """
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(GarretCSLexer, GarretCSParser, 'garret_cs', csText,
                           filePath=csFilePath, saModule=sa_garretcs,
            ...
            listener = GarretCSParserListener(self.__verbose, self.__log,
...
if __name__ == "__main__":
    ...
    reader = GarretCSReader(True, polySeq=nmr_poly_seq, entityAssembly=entity_assembly)
    reader.setDebugMode(True)
    reader.parse('../../tests-nmr/mock-data-atypical-cs/garret/camra_example.garret')
