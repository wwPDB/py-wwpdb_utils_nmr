...
# Update:
##
""" A collection of classes for parsing PPM CS files.
"""
...
try:
    ...
    from wwpdb.utils.nmr.cs import sa_ppmcs
    from wwpdb.utils.nmr.mr.LexerErrorListener import LexerErrorListener
    from wwpdb.utils.nmr.mr.ParserErrorListener import ParserErrorListener
    from wwpdb.utils.nmr.cs.PpmCSLexer import PpmCSLexer
    from wwpdb.utils.nmr.cs.PpmCSParser import PpmCSParser
    from wwpdb.utils.nmr.cs.PpmCSParserListener import PpmCSParserListener
except ImportError:
    ...
    from nmr.cs import sa_ppmcs
    from nmr.mr.LexerErrorListener import LexerErrorListener
    from nmr.mr.ParserErrorListener import ParserErrorListener
    from nmr.cs.PpmCSLexer import PpmCSLexer
    from nmr.cs.PpmCSParser import PpmCSParser
    from nmr.cs.PpmCSParserListener import PpmCSParserListener


class PpmCSReader:
    """ Accessor methods for parsing PPM CS files.
    """
    ...
    def parse(self, csFilePath: str, isFilePath: bool = True,
              ...
              ) -> Tuple[Optional[PpmCSParserListener], Optional[ParserErrorListener], Optional[LexerErrorListener]]:
        """ Parse PPM CS file.
            @return: PpmCSParserListener for success or None otherwise, ParserErrorListener, LexerErrorListener.
        """
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(PpmCSLexer, PpmCSParser, 'ppm_cs', csText,
                           filePath=csFilePath, saModule=sa_ppmcs,
            ...
            listener = PpmCSParserListener(self.__verbose, self.__log,
...
if __name__ == "__main__":
    ...
    reader = PpmCSReader(True, polySeq=nmr_poly_seq, entityAssembly=entity_assembly)
    reader.setDebugMode(True)
    reader.parse('../../tests-nmr/mock-data-atypical-cs/ppm/camra_example.ppm')

    reader = PpmCSReader(True, polySeq=nmr_poly_seq, entityAssembly=entity_assembly)
    reader.setDebugMode(True)
    reader.parse('../../tests-nmr/mock-data-atypical-cs/ppm/nmrview_example.ppm')
