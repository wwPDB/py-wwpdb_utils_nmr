...
from .BareCSParser import BareCSParser
from .BareCSLexer import BareCSLexer
...
try:
    from . import sa_barecs_cpp_parser
except ImportError:
...
def _cpp_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    return sa_barecs_cpp_parser.do_parse(BareCSParser, stream, entry_rule_name, sa_err_listener, prediction_mode_sll)
...
def _py_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    # Parse
    parser = BareCSParser(token_stream)
