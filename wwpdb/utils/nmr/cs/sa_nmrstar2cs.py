...
from .NmrStar2CSParser import NmrStar2CSParser
from .NmrStar2CSLexer import NmrStar2CSLexer
...
try:
    from . import sa_nmrstar2cs_cpp_parser
except ImportError:
...
def _cpp_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    return sa_nmrstar2cs_cpp_parser.do_parse(NmrStar2CSParser, stream, entry_rule_name, sa_err_listener, prediction_mode_sll)
...
def _py_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    # Parse
    parser = NmrStar2CSParser(token_stream)
