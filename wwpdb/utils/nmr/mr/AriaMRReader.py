...
try:
    ...
    from wwpdb.utils.nmr.mr import sa_ariamr
    ...
    def parse(self, mrFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(AriaMRLexer, AriaMRParser, 'aria_mr', mrText,
                           filePath=mrFilePath, saModule=sa_ariamr,
