...
class AriaMRXParserListener(ParseTreeListener):

    __file_type = 'nm-res-arx'
    ...
    def exitDistance_restraint(self):
        ...
        try:
            ...
            for atom_pair in self.__cur_contrib:
                ...
                dstFunc = self.validateDistanceRange(self.__weight, self.__target_value, self.__lower_limit, self.__upper_limit, self.__omitDistLimitOutlier)
    ...
    def getPolymerSequence(self) -> Optional[List[dict]]:
        """ Return polymer sequence of ARIA MRX file.
        """
    ...
    def getSequenceAlignment(self) -> Optional[List[dict]]:
        """ Return sequence alignment between coordinates and ARIA MRX.
        """
    ...
    def getChainAssignment(self) -> Optional[List[dict]]:
        """ Return chain assignment between coordinates and ARIA MRX.
        """

        return None if self.__chainAssign is None or len(self.__chainAssign) == 0 else self.__chainAssign

    def getReasonsForReparsing(self) -> Optional[dict]:
        """ Return reasons for re-parsing ARIA MRX file.
        """
