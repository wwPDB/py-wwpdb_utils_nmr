    ...
    def parse(self, mrFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(XMLLexer, XMLParser, 'document', mrText,
                           filePath=mrFilePath, saModule=sa_xml,
            ...
            listener = AriaMRXParserListener(self.__verbose, self.__log,
...
if __name__ == "__main__":
    ...
    reader.parse('../../tests-nmr/mock-data-remediation/2n7h/2n7h-trimmed.mr',
                 '../../tests-nmr/mock-data-remediation/2n7h/2n7h.cif')
