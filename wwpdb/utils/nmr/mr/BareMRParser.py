...
class BareMRParser ( Parser ):
    ...
    RULE_bare_mr = 0
    RULE_mr_raw_format = 1
    RULE_mr_raw_list = 2
    RULE_any = 3

    ruleNames =  [ "bare_mr", "mr_raw_format", "mr_raw_list", "any" ]
    ...
    class Bare_mrContext(ParserRuleContext):
        ...
        def mr_raw_format(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(BareMRParser.Mr_raw_formatContext)
            else:
                return self.getTypedRuleContext(BareMRParser.Mr_raw_formatContext,i)
    ...
    class Mr_raw_formatContext(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def mr_raw_list(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(BareMRParser.Mr_raw_listContext)
            else:
                return self.getTypedRuleContext(BareMRParser.Mr_raw_listContext,i)


        def Simple_name(self, i:int=None):
            if i is None:
                return self.getTokens(BareMRParser.Simple_name)
            else:
                return self.getToken(BareMRParser.Simple_name, i)

        def Double_quote_string(self, i:int=None):
            if i is None:
                return self.getTokens(BareMRParser.Double_quote_string)
            else:
                return self.getToken(BareMRParser.Double_quote_string, i)

        def getRuleIndex(self):
            return BareMRParser.RULE_mr_raw_format

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterMr_raw_format" ):
                listener.enterMr_raw_format(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitMr_raw_format" ):
                listener.exitMr_raw_format(self)




    def mr_raw_format(self):

        localctx = BareMRParser.Mr_raw_formatContext(self, self._ctx, self.state)
        self.enterRule(localctx, 2, self.RULE_mr_raw_format)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 30
            ...
            if token in [5]:
                ...
                while True:
                    self.state = 20
                    self.match(BareMRParser.Simple_name)
                    self.state = 23 
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if not (_la==5):
                ...
                while True:
                    self.state = 25
                    self.match(BareMRParser.Double_quote_string)
                    self.state = 28 
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if not (_la==6):
    ...
    class Mr_raw_listContext(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def getRuleIndex(self):
            return BareMRParser.RULE_mr_raw_list

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterMr_raw_list" ):
                listener.enterMr_raw_list(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitMr_raw_list" ):
                listener.exitMr_raw_list(self)




    def mr_raw_list(self):

        localctx = BareMRParser.Mr_raw_listContext(self, self._ctx, self.state)
        self.enterRule(localctx, 4, self.RULE_mr_raw_list)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 39 
