...
# Update:
##
""" A collection of classes for parsing Bare WSV/TSV/CSV MR files.
"""
...
try:
    ...
    from wwpdb.utils.nmr.mr import sa_baremr
    from wwpdb.utils.nmr.mr.LexerErrorListener import LexerErrorListener
    from wwpdb.utils.nmr.mr.ParserErrorListener import ParserErrorListener
    from wwpdb.utils.nmr.mr.BareMRLexer import BareMRLexer
    from wwpdb.utils.nmr.mr.BareMRParser import BareMRParser
    from wwpdb.utils.nmr.mr.BareMRParserListener import BareMRParserListener
    ...
    from nmr.mr import sa_baremr
    from nmr.mr.LexerErrorListener import LexerErrorListener
    from nmr.mr.ParserErrorListener import ParserErrorListener
    from nmr.mr.BareMRLexer import BareMRLexer
    from nmr.mr.BareMRParser import BareMRParser
    from nmr.mr.BareMRParserListener import BareMRParserListener
    from nmr.mr.ParserListenerUtil import (coordAssemblyChecker,
                                           retrieveOriginalFileName)


class BareMRReader:
    """ Accessor methods for parsing Bare WSV/TSV/CSV MR files.
    """
    ...
    def parse(self, mrFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
              ...
              ) -> Tuple[Optional[BareMRParserListener], Optional[ParserErrorListener], Optional[LexerErrorListener]]:
        """ Parse Bare WSV/TSV/CSV MR file.
            @return: BareMRParserListener for success or None otherwise, ParserErrorListener, LexerErrorListener.
        """
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(BareMRLexer, BareMRParser, 'bare_mr', mrText,
                           filePath=mrFilePath, saModule=sa_baremr,
            ...
            listener = BareMRParserListener(self.__verbose, self.__log,
...
if __name__ == "__main__":
    ...
    reader.parse('../../tests-nmr/mock-data-remediation/6qbz/dangle.tbl',
                 '../../tests-nmr/mock-data-remediation/6qbz/6qbz.cif')
    ...
    reader = BareMRReader(True)
    reader.setDebugMode(True)
    reader.parse('../../tests-nmr/mock-data-remediation/6gz7/bmr34296/work/data/D_1200010375_mr-upload_P1.dat.V3',
                 '../../tests-nmr/mock-data-remediation/6gz7/6gz7.cif')
