...
class BarePDBParserListener(ParseTreeListener):

    __file_type = 'nm-aux-pdb'
    ...
    # polymer sequence of Bare PDB (parameter/topology) file
    ...
    def getAtomNumberDict(self) -> Optional[dict]:
        """ Return PDB atomic number dictionary.
        """

        return self.__atomNumberDict

    def getPolymerSequence(self) -> Optional[List[dict]]:
        """ Return polymer sequence of Bare PDB file.
        """
    ...
    def getSequenceAlignment(self) -> Optional[List[dict]]:
        """ Return sequence alignment between coordinates and Bare PDB.
        """
    ...
    def getChainAssignment(self) -> Optional[List[dict]]:
        """ Return chain assignment between coordinates and Bare PDB.
        """
