...
class BiosymMRParserListener(ParseTreeListener):
    ...
    def exitDistance_restraint(self, ctx: BiosymMRParser.Distance_restraintContext):
        ...
        try:
            ...
            chainAssign1, asis1 = self.assignCoordPolymerSequence(chainId1, seqId1, compId1, atomId1.split('|', 1)[0])
            chainAssign2, asis2 = self.assignCoordPolymerSequence(chainId2, seqId2, compId2, atomId2.split('|', 1)[0])
    ...
    def __getCurrentRestraint(self) -> str:
        ...
        if self.__cur_subtype == 'geo':
            return f"[Check the {self.geoRestraints}th row of chirality/prochirality restraints, {self.__def_err_sf_framecode}] "
        return ''
