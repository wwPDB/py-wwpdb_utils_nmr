...
def serializedATN():
    return [
        4,1,13,45,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,1,0,1,0,5,0,11,8,0,10,
        ...
        3,1,3,1,3,1,3,1,3,1,3,0,0,4,0,2,4,6,0,1,1,1,13,13,44,0,12,1,0,0,
        ...
        21,5,4,0,0,18,20,5,11,0,0,19,18,1,0,0,0,20,23,1,0,0,0,21,19,1,0,
        ...
        0,0,34,35,5,1,0,0,35,36,5,5,0,0,36,37,5,5,0,0,37,38,5,2,0,0,38,39,
        5,2,0,0,39,40,5,2,0,0,40,41,5,5,0,0,41,42,5,1,0,0,42,43,5,2,0,0,
...
class CharmmCRDParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "Integer", "Float", "Double_quote_string", 
                      "COMMENT", "Simple_name", "SPACE", "CONTINUE", "ENCLOSE_COMMENT", 
    ...
    class CoordinatesContext(ParserRuleContext):
        ...
        def Simple_name(self):
            return self.getToken(CharmmCRDParser.Simple_name, 0)
