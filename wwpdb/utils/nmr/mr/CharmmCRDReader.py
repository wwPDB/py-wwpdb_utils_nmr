...
try:
    ...
    from wwpdb.utils.nmr.mr import sa_charmmcrd
    ...
    from nmr.mr import sa_charmmcrd
    ...
    def parse(self, crdFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(CharmmCRDLexer, CharmmCRDParser, 'charmm_crd', crdText,
                           filePath=crdFilePath, saModule=sa_charmmcrd,
            ...
            listener = CharmmCRDParserListener(self.__verbose, self.__log,
