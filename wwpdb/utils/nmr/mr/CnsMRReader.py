...
try:
    ...
    from wwpdb.utils.nmr.mr import sa_cnsmr
    ...
    def parse(self, mrFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(CnsMRLexer, CnsMRParser, 'cns_mr', mrText,
                           filePath=mrFilePath, saModule=sa_cnsmr,
            ...
            listener = CnsMRParserListener(self.__verbose, self.__log,
...
if __name__ == "__main__":
    ...
    reader.setDebugMode(False)
    reader_listener, _, _ =\
        reader.parse('../../tests-nmr/mock-data-combine-at-upload/bmr36759/data/D_1300059252_mr-upload_P1.xplor-nih.V1',
                     '../../tests-nmr/mock-data-combine-at-upload/bmr36759/data/D_1300059252_model-release_P1.cif.V1')
    print(reader_listener.getReasonsForReparsing())
    reader = CnsMRReader(True, reasons=reader_listener.getReasonsForReparsing())
    reader.setDebugMode(True)
    reader.parse('../../tests-nmr/mock-data-combine-at-upload/bmr36759/data/D_1300059252_mr-upload_P1.xplor-nih.V1',
    ...
    mrAtomNameMapping_ = [
        {'auth_atom_id': 'HC1', 'auth_comp_id': 'MEA', 'auth_seq_id': 3,
    ...
    mrAtomNameMapping_ = [
        {'auth_atom_id': 'H8', 'auth_comp_id': '4FU', 'auth_seq_id': 6,
