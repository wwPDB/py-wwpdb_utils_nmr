...
try:
    ...
    from wwpdb.utils.nmr.mr.CyanaEMRLexer import CyanaEMRLexer
    from wwpdb.utils.nmr.mr.CyanaEMRParser import CyanaEMRParser
    from wwpdb.utils.nmr.mr.CyanaEMRParserListener import CyanaEMRParserListener
    ...
    from nmr.mr.CyanaEMRLexer import CyanaEMRLexer
    from nmr.mr.CyanaEMRParser import CyanaEMRParser
    from nmr.mr.CyanaEMRParserListener import CyanaEMRParserListener
...
class CyanaEMRReader:
    ...
    def parse(self, mrFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
              ...
              ) -> Tuple[Optional[CyanaEMRParserListener], Optional[ParserErrorListener], Optional[LexerErrorListener]]:
        """ Parse CYANA MR file.
            @return: CyanaEMRParserListener for success or None otherwise, ParserErrorListener, LexerErrorListener.
        """
        ...
        try:
            ...
            tree = parser.cyana_emr()

            walker = ParseTreeWalker()
            listener = CyanaEMRParserListener(self.__verbose, self.__lfh,
