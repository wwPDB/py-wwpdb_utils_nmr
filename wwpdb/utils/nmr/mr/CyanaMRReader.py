...
try:
    ...
    from wwpdb.utils.nmr.mr import sa_cyanamr
    ...
    def parse(self, mrFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(CyanaMRLexer, CyanaMRParser, 'cyana_mr', mrText,
                           filePath=mrFilePath, saModule=sa_cyanamr,
            ...
            listener = CyanaMRParserListener(self.__verbose, self.__log,
...
if __name__ == "__main__":
    ...
    mrAtomNameMapping_ = [
        {'auth_atom_id': 'H4', 'auth_comp_id': 'NGH', 'auth_seq_id': 253,
    ...
    reader = CyanaMRReader(True, mrAtomNameMapping=mrAtomNameMapping_)
    reader.setDebugMode(True)
