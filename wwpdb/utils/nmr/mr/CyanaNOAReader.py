...
try:
    ...
    from wwpdb.utils.nmr.mr import sa_cyananoa
    ...
    from nmr.mr import sa_cyananoa
    ...
    def parse(self, mrFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(CyanaNOALexer, CyanaNOAParser, 'cyana_noa', mrText,
                           filePath=mrFilePath, saModule=sa_cyananoa,
            ...
            listener = CyanaNOAParserListener(self.__verbose, self.__log,
