...
try:
    ...
    from wwpdb.utils.nmr.mr.RosettaEMRLexer import RosettaEMRLexer
    from wwpdb.utils.nmr.mr.RosettaEMRParser import RosettaEMRParser
    from wwpdb.utils.nmr.mr.RosettaEMRParserListener import RosettaEMRParserListener
    ...
    from nmr.mr.RosettaEMRLexer import RosettaEMRLexer
    from nmr.mr.RosettaEMRParser import RosettaEMRParser
    from nmr.mr.RosettaEMRParserListener import RosettaEMRParserListener
...
class RosettaEMRReader:
    ...
    def parse(self, mrFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
              ...
              ) -> Tuple[Optional[RosettaEMRParserListener], Optional[ParserErrorListener], Optional[LexerErrorListener]]:
        """ Parse ROSETTA MR file.
            @return: RosettaEMRParserListener for success or None otherwise, ParserErrorListener, LexerErrorListener.
        """
        ...
        try:
            ...
            parser = RosettaEMRParser(stream)
            ...
            tree = parser.rosetta_emr()

            walker = ParseTreeWalker()
            listener = RosettaEMRParserListener(self.__verbose, self.__lfh,
