...
try:
    ...
    from wwpdb.utils.nmr.mr import sa_rosettamr
    ...
    from nmr.mr import sa_rosettamr
    ...
    def parse(self, mrFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(RosettaMRLexer, RosettaMRParser, 'rosetta_mr', mrText,
                           filePath=mrFilePath, saModule=sa_rosettamr,
            ...
            listener = RosettaMRParserListener(self.__verbose, self.__log,
