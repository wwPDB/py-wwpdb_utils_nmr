##
# SchrodingerMRReader.py
#
# Update:
##
""" A collection of classes for parsing SCHRODINGER MR files.
"""
...
try:
    ...
    from wwpdb.utils.nmr.mr import sa_schrodingermr
    from wwpdb.utils.nmr.mr.LexerErrorListener import LexerErrorListener
    from wwpdb.utils.nmr.mr.ParserErrorListener import ParserErrorListener
    from wwpdb.utils.nmr.mr.SchrodingerMRLexer import SchrodingerMRLexer
    from wwpdb.utils.nmr.mr.SchrodingerMRParser import SchrodingerMRParser
    from wwpdb.utils.nmr.mr.SchrodingerMRParserListener import SchrodingerMRParserListener
    ...
    from nmr.mr import sa_schrodingermr
    from nmr.mr.LexerErrorListener import LexerErrorListener
    from nmr.mr.ParserErrorListener import ParserErrorListener
    from nmr.mr.SchrodingerMRLexer import SchrodingerMRLexer
    from nmr.mr.SchrodingerMRParser import SchrodingerMRParser
    from nmr.mr.SchrodingerMRParserListener import SchrodingerMRParserListener
...
class SchrodingerMRReader:
    ...
    def parse(self, mrFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
              ...
              ) -> Tuple[Optional[SchrodingerMRParserListener], Optional[ParserErrorListener], Optional[LexerErrorListener]]:
        """ Parse SCHRODINGER MR file.
            @return: SchrodingerMRParserListener for success or None otherwise, ParserErrorListener, LexerErrorListener.
        """
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(SchrodingerMRLexer, SchrodingerMRParser, 'schrodinger_mr', mrText,
                           filePath=mrFilePath, saModule=sa_schrodingermr,
            ...
            listener = SchrodingerMRParserListener(self.__verbose, self.__log,
...
if __name__ == "__main__":
    reader = SchrodingerMRReader(True)
    reader.setDebugMode(True)
    reader_listener, _, _ =\
        reader.parse('../../tests-nmr/mock-data-daother-10172/Distance_restraint_HAP_Ebut.asl',
                     '../../tests-nmr/mock-data-daother-10172/D_800840_model_P1.cif.V4')
