...
try:
    ...
    from wwpdb.utils.nmr.mr import sa_sybylmr
    ...
    def parse(self, mrFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(SybylMRLexer, SybylMRParser, 'sybyl_mr', mrText,
                           filePath=mrFilePath, saModule=sa_sybylmr,
            ...
            listener = SybylMRParserListener(self.__verbose, self.__log,
