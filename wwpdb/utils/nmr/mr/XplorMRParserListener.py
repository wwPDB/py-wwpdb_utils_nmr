...
class XplorMRParserListener(ParseTreeListener):
    ...
    # polymer sequences in the atom_site loop generated by NmrDpUtility.__extractCoordPolymerSequenceInLoop()
    polySeqInLoop = None
    ...
    def __init__(self, polySeq=None, polySeqInLoop=None):
        self.polySeq = polySeq
        self.polySeqInLoop = polySeqInLoop
