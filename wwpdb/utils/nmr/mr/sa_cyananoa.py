...
from .CyanaNOAParser import CyanaNOAParser
from .CyanaNOALexer import CyanaNOALexer
...
try:
    from . import sa_cyananoa_cpp_parser
except ImportError:
...
def _cpp_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    return sa_cyananoa_cpp_parser.do_parse(CyanaNOAParser, stream, entry_rule_name, sa_err_listener, prediction_mode_sll)
...
def _py_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    # Parse
    parser = CyanaNOAParser(token_stream)
