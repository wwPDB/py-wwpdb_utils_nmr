...
from .GromacsMRParser import GromacsMRParser
from .GromacsMRLexer import GromacsMRLexer
...
try:
    from . import sa_gromacsmr_cpp_parser
except ImportError:
...
def _cpp_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    return sa_gromacsmr_cpp_parser.do_parse(GromacsMRParser, stream, entry_rule_name, sa_err_listener, prediction_mode_sll)
...
def _py_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    # Parse
    parser = GromacsMRParser(token_stream)
