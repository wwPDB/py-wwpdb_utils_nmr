...
from .GromacsPTParser import GromacsPTParser
from .GromacsPTLexer import GromacsPTLexer
...
try:
    from . import sa_gromacspt_cpp_parser
except ImportError:
...
def _cpp_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    return sa_gromacspt_cpp_parser.do_parse(GromacsPTParser, stream, entry_rule_name, sa_err_listener, prediction_mode_sll)
...
def _py_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    # Parse
    parser = GromacsPTParser(token_stream)
