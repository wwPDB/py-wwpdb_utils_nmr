...
from .SchrodingerMRParser import SchrodingerMRParser
from .SchrodingerMRLexer import SchrodingerMRLexer
...
try:
    from . import sa_schrodingermr_cpp_parser
except ImportError:
...
def _cpp_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    return sa_schrodingermr_cpp_parser.do_parse(SchrodingerMRParser, stream, entry_rule_name, sa_err_listener, prediction_mode_sll)
...
def _py_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    # Lex
    lexer = SchrodingerMRLexer(stream)
    if sa_err_listener is not None:
    ...
    # Parse
    parser = SchrodingerMRParser(token_stream)
