...
try:
    ...
    from wwpdb.utils.nmr.pk import sa_xml
    ...
    def parse(self, pkFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(XMLLexer, XMLParser, 'document', pkText,
                           filePath=pkFilePath, saModule=sa_xml,
            ...
            listener = AriaPKParserListener(self.__verbose, self.__log,
