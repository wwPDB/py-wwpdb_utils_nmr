...
try:
    ...
    from wwpdb.utils.nmr.pk import sa_barepk
    from wwpdb.utils.nmr.mr.LexerErrorListener import LexerErrorListener
    from wwpdb.utils.nmr.mr.ParserErrorListener import ParserErrorListener
    from wwpdb.utils.nmr.mr.ParserListenerUtil import coordAssemblyChecker
    from wwpdb.utils.nmr.pk.BarePKLexer import BarePKLexer
    from wwpdb.utils.nmr.pk.BarePKParser import BarePKParser
    from wwpdb.utils.nmr.pk.BarePKParserListener import BarePKParserListener
except ImportError:
    ...
    from nmr.pk import sa_barepk
    from nmr.mr.LexerErrorListener import LexerErrorListener
    from nmr.mr.ParserErrorListener import ParserErrorListener
    from nmr.mr.ParserListenerUtil import coordAssemblyChecker
    from nmr.pk.BarePKLexer import BarePKLexer
    from nmr.pk.BarePKParser import BarePKParser
    from nmr.pk.BarePKParserListener import BarePKParserListener
    ...
    def parse(self, pkFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(BarePKLexer, BarePKParser, 'bare_pk', pkText,
                           filePath=pkFilePath, saModule=sa_barepk,
            ...
            listener = BarePKParserListener(self.__verbose, self.__log,
...
if __name__ == "__main__":
    ...
    reader_listener, _, _ =\
        reader.parse('../../tests-nmr/mock-data-remediation/6m6j/bmr36325/work/data/D_1300010166_nmr-peaks-upload_P1.dat.V2',
                     '../../tests-nmr/mock-data-remediation/6m6j/6m6j.cif')
