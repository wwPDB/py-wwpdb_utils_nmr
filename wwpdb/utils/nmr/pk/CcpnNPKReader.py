...
# Update:
##
""" A collection of classes for parsing CCPN NPK files.
"""
...
try:
    ...
    from wwpdb.utils.nmr.pk.CcpnNPKLexer import CcpnNPKLexer
    from wwpdb.utils.nmr.pk.CcpnNPKParser import CcpnNPKParser
    from wwpdb.utils.nmr.pk.CcpnNPKParserListener import CcpnNPKParserListener
    ...
    from nmr.pk.CcpnNPKLexer import CcpnNPKLexer
    from nmr.pk.CcpnNPKParser import CcpnNPKParser
    from nmr.pk.CcpnNPKParserListener import CcpnNPKParserListener
...
class CcpnNPKReader:
    """ Accessor methods for parsing CCPN NPK files.
    """
    ...
    def parse(self, pkFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
              ...
              ) -> Tuple[Optional[CcpnNPKParserListener], Optional[ParserErrorListener], Optional[LexerErrorListener]]:
        """ Parse CCPN NPK file.
            @return: CcpnNPKParserListener for success or None otherwise, ParserErrorListener, LexerErrorListener.
        """
        ...
        try:
            ...
            tree = parser.ccpn_npk()

            walker = ParseTreeWalker()
            listener = CcpnNPKParserListener(self.__verbose, self.__lfh,
