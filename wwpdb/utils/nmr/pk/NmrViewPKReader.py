...
try:
    ...
    from wwpdb.utils.nmr.pk import sa_nmrviewpk
    ...
    from nmr.pk import sa_nmrviewpk
    ...
    def parse(self, pkFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(NmrViewPKLexer, NmrViewPKParser, 'nmrview_pk', pkText,
                           filePath=pkFilePath, saModule=sa_nmrviewpk,
            ...
            listener = NmrViewPKParserListener(self.__verbose, self.__log,
