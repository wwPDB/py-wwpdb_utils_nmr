##
# PonderosaPKReader.py
#
# Update:
##
""" A collection of classes for parsing PONDEROSA PK files.
"""
...
try:
    ...
    from wwpdb.utils.nmr.pk import sa_ponderosapk
    from wwpdb.utils.nmr.mr.LexerErrorListener import LexerErrorListener
    from wwpdb.utils.nmr.mr.ParserErrorListener import ParserErrorListener
    from wwpdb.utils.nmr.mr.ParserListenerUtil import coordAssemblyChecker
    from wwpdb.utils.nmr.pk.PonderosaPKLexer import PonderosaPKLexer
    from wwpdb.utils.nmr.pk.PonderosaPKParser import PonderosaPKParser
    from wwpdb.utils.nmr.pk.PonderosaPKParserListener import PonderosaPKParserListener
except ImportError:
    ...
    from nmr.pk import sa_ponderosapk
    from nmr.mr.LexerErrorListener import LexerErrorListener
    from nmr.mr.ParserErrorListener import ParserErrorListener
    from nmr.mr.ParserListenerUtil import coordAssemblyChecker
    from nmr.pk.PonderosaPKLexer import PonderosaPKLexer
    from nmr.pk.PonderosaPKParser import PonderosaPKParser
    from nmr.pk.PonderosaPKParserListener import PonderosaPKParserListener


class PonderosaPKReader:
    """ Accessor methods for parsing PONDEROSA PK files.
    """
    ...
    def parse(self, pkFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
              ...
              ) -> Tuple[Optional[PonderosaPKParserListener], Optional[ParserErrorListener], Optional[LexerErrorListener]]:
        """ Parse PONDEROSA PK file.
            @return: PonderosaPKParserListener for success or None otherwise, ParserErrorListener, LexerErrorListener.
        """
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(PonderosaPKLexer, PonderosaPKParser, 'ponderosa_pk', pkText,
                           filePath=pkFilePath, saModule=sa_ponderosapk,
            ...
            listener = PonderosaPKParserListener(self.__verbose, self.__log,
...
if __name__ == "__main__":
    reader = PonderosaPKReader(True)
    reader.setDebugMode(True)
    reader.parse('../../tests-nmr/mock-data-remediation/7uv1/bmr31013/work/data/D_1000264915_nmr-peaks-upload_P10.dat.V1',
