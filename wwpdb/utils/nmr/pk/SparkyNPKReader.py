...
try:
    ...
    from wwpdb.utils.nmr.pk import sa_sparkynpk
    ...
    from nmr.pk import sa_sparkynpk
    ...
    def parse(self, pkFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(SparkyPKLexer, SparkyNPKParser, 'sparky_npk', pkText,
                           filePath=pkFilePath, saModule=sa_sparkynpk,
            ...
            listener = SparkyNPKParserListener(self.__verbose, self.__log,
...
if __name__ == "__main__":
    ...
    reader.setDebugMode(True)
    reader.setInternalMode(True)
    reader.parse('../../tests-nmr/mock-data-remediation/6jce/bmr36237/work/data/D_1300010831_nmr-peaks-upload_P1.dat.V1',
                 '../../tests-nmr/mock-data-remediation/6jce/6jce.cif')
