...
try:
    ...
    from wwpdb.utils.nmr.pk import sa_sparkyspk
    ...
    from nmr.pk import sa_sparkyspk
    ...
    def parse(self, pkFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(SparkySPKLexer, SparkySPKParser, 'sparky_spk', pkText,
                           filePath=pkFilePath, saModule=sa_sparkyspk,
            ...
            listener = SparkySPKParserListener(self.__verbose, self.__log,
...
if __name__ == "__main__":
    ...
    reader.parse('../../tests-nmr/mock-data-remediation/6izg/bmr36226/work/data/D_1300010137_nmr-peaks-upload_P2.dat.V2',
                 '../../tests-nmr/mock-data-remediation/6izg/6izg.cif')
