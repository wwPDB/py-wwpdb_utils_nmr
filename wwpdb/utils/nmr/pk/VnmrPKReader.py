...
try:
    ...
    from wwpdb.utils.nmr.pk import sa_vnmrpk
...
class VnmrPKReader:
    ...
    def parse(self, pkFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
              ...
              ) -> Tuple[Optional[VnmrPKParserListener], Optional[ParserErrorListener], Optional[LexerErrorListener]]:
        """ Parse VNMR PK file.
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(VnmrPKLexer, VnmrPKParser, 'vnmr_pk', pkText,
                           filePath=pkFilePath, saModule=sa_vnmrpk,
            ...
            listener = VnmrPKParserListener(self.__verbose, self.__log,
