...
try:
    ...
    from wwpdb.utils.nmr.pk import sa_xwinnmrpk
    ...
    from nmr.pk import sa_xwinnmrpk
...
class XwinNmrPKReader:
    ...
    def parse(self, pkFilePath: str, cifFilePath: Optional[str] = None, isFilePath: bool = True,
              ...
              ) -> Tuple[Optional[XwinNmrPKParserListener], Optional[ParserErrorListener], Optional[LexerErrorListener]]:
        ...
        try:
            ...
            tree, parser_error_listener, lexer_error_listener =\
                parseAntlr(XwinNmrPKLexer, XwinNmrPKParser, 'xwinnmr_pk', pkText,
                           filePath=pkFilePath, saModule=sa_xwinnmrpk,
            ...
            listener = XwinNmrPKParserListener(self.__verbose, self.__log,
