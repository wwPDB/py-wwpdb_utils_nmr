...
from .PonderosaPKParser import PonderosaPKParser
from .PonderosaPKLexer import PonderosaPKLexer
...
try:
    from . import sa_ponderosapk_cpp_parser
except ImportError:
...
def _cpp_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    return sa_ponderosapk_cpp_parser.do_parse(PonderosaPKParser, stream, entry_rule_name, sa_err_listener, prediction_mode_sll)
...
def _py_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    # Parse
    parser = PonderosaPKParser(token_stream)
