...
from .SparkyNPKParser import SparkyNPKParser
from .SparkyPKLexer import SparkyPKLexer
...
try:
    from . import sa_sparkynpk_cpp_parser
except ImportError:
...
def _cpp_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    return sa_sparkynpk_cpp_parser.do_parse(SparkyNPKParser, stream, entry_rule_name, sa_err_listener, prediction_mode_sll)
...
def _py_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None,
    ...
    # Parse
    parser = SparkyNPKParser(token_stream)
