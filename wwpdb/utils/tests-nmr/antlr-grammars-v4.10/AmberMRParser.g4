...
shf_factor:
	...
	(STR | SHRANG | WT) L_paren_RA Decimal R_paren_A Equ_op_RA (Reals | MultiplicativeReal) (Comma_RA | End_RA) |
...
pcshf_factor:
	...
	(WT | TOLPRO) L_paren_RA Decimal R_paren_A Equ_op_RA (Reals | MultiplicativeReal) (Comma_RA | End_RA) |
...
align_factor:
	...
	(ID | JD | DATASET) L_paren_IP Decimal R_paren_A Equ_op_IP Integer Comma? |
	(DOBSL | DOBSU) L_paren_RP Decimal R_paren_A Equ_op_RP Real Comma? |
	(DWT | GIGJ | DIJ) L_paren_RA Decimal R_paren_A Equ_op_RA Reals (Comma_RA | End_RA) |
