/*
 CYANA MR (Magnetic Restraint - extended for multiple chains) parser grammar for ANTLR v4.
...
fixres_distance_restraint:
	gen_res_num gen_simple_name comment?
	(gen_simple_name gen_res_num gen_simple_name gen_simple_name number | comment)+;
...
fixresw_distance_restraint:
	gen_res_num gen_simple_name comment?
	(gen_simple_name gen_res_num gen_simple_name gen_simple_name number number | comment)+;
...
fixresw2_distance_restraint:
	gen_res_num gen_simple_name comment?
	(gen_simple_name gen_res_num gen_simple_name gen_simple_name number number number | comment)+;
...
fixatm_distance_restraint:
	gen_res_num gen_simple_name gen_simple_name comment?
	(gen_res_num gen_simple_name gen_simple_name number | comment)+;
...
fixatmw_distance_restraint:
	gen_res_num gen_simple_name gen_simple_name comment?
	(gen_res_num gen_simple_name gen_simple_name number number | comment)+;
...
fixatmw2_distance_restraint:
	gen_res_num gen_simple_name gen_simple_name comment?
	(gen_res_num gen_simple_name gen_simple_name number number number | comment)+;

/* DIANA distance restraints generated by 'qconvert' script (undocumented) */
qconvr_distance_restraints:
	qconvr_distance_restraint+;

qconvr_distance_restraint:
	(NoeUpp | NoeLow)
	gen_simple_name gen_res_num gen_simple_name
	gen_simple_name gen_res_num gen_simple_name
	number;
...
distance_w_chain_restraint:
	Integer gen_simple_name gen_simple_name gen_simple_name
	Integer gen_simple_name gen_simple_name gen_simple_name
	number number? number?
	number? number? number?;	// extensions for .cco file
...
distance_w_chain2_restraint:
	gen_simple_name Integer gen_simple_name gen_simple_name
	gen_simple_name Integer gen_simple_name gen_simple_name
	number number? number?
	number? number? number?;	// extensions for .cco file
...
distance_w_chain3_restraint:
	gen_simple_name gen_simple_name Integer gen_simple_name
	gen_simple_name gen_simple_name Integer gen_simple_name
	number number? number?
	number? number? number?;	// extensions for .cco file
...
torsion_angle_w_chain_restraint:
	gen_simple_name Integer gen_simple_name gen_simple_name number number number? (Type Equ_op Integer)? Or?;
