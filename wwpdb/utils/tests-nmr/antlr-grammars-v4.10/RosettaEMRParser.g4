/*
 ROSETTA EMR (Magnetic Restraint - extended for multiple chains) parser grammar for ANTLR v4.
...
parser grammar RosettaEMRParser;

options { tokenVocab=RosettaEMRLexer; }
...
comment:
	COMMENT (Atom_pair_selection | Atom_selection | Any_name)* (RETURN_CM | EOF);
