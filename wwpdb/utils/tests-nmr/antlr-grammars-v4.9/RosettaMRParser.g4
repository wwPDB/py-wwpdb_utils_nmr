...
func_type_def:
	...
	BOUNDED number_f number_f number_f number_f? (Simple_name | Integer)* |
	PERIODICBOUNDED number_f number_f number_f number_f number_f? (Simple_name | Integer)* |
	OFFSETPERIODICBOUNDED number_f number_f number_f number_f number_f number_f? (Simple_name | Integer)* |
