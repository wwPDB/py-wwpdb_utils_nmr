...
ATOMS_PER_MOLECULE:	'ATOMS_PER_MOLECULE' RETURN;
...
BOX_DIMENSIONS:		'BOX_DIMENSIONS' RETURN;
CAP_INFO:		'CAP_INFO' RETURN;
CAP_INFO2:		'CAP_INFO2' RETURN;
...
POLARIZABILITY:		'POLARIZABILITY' RETURN;
RADII:			'RADII' RETURN;
...
SOLTY:			'SOLTY' RETURN;
SOLVENT_POINTERS:	'SOLVENT_POINTERS' RETURN;
TITLE:			'TITLE' RETURN;
