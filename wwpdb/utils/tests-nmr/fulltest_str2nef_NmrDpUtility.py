...
class TestNmrDpUtility(unittest.TestCase):
    ...
    def __test_nmr_str2nef_deposit_check(self, entry_id):
        ...
        self.utility.setLog(self.data_dir_path + entry_id + '-str2nef-deposit-log.json')
        self.utility.setDestination(self.data_dir_path + entry_id + '-str2nef-next.nef')
        self.utility.addOutput(name='nef_file_path', value=self.data_dir_path + entry_id + '-str2nef.str', type='file')
        self.utility.addOutput(name='report_file_path', value=self.data_dir_path + entry_id + '-str2nef-nef-deposit-log.json', type='file')
        self.utility.addOutput(name='entry_id', value='NEED_ACC_NO', type='param')
        self.utility.setVerbose(False)

        self.utility.op('nmr-str2nef-deposit')

        with open(self.data_dir_path + entry_id + '-str2nef-nef-deposit-log.json', 'r') as file:
            report = json.loads(file.read())
    ...
    def test_nmr_str2nef_deposit_check_1nk2(self):
        self.__test_nmr_str2nef_deposit_check('1nk2')

    def test_nmr_str2nef_deposit_check_2kko(self):
        self.__test_nmr_str2nef_deposit_check('2kko')

    def test_nmr_str2nef_deposit_check_2mqq(self):
        self.__test_nmr_str2nef_deposit_check('2mqq')

    def test_nmr_str2nef_deposit_check_2mtv(self):
        self.__test_nmr_str2nef_deposit_check('2mtv')

    def test_nmr_str2nef_deposit_check_2l9r(self):
        self.__test_nmr_str2nef_deposit_check('2l9r')

    def test_nmr_str2nef_deposit_check_2la6(self):
        self.__test_nmr_str2nef_deposit_check('2la6')

    def test_nmr_str2nef_deposit_check_2lah(self):
        self.__test_nmr_str2nef_deposit_check('2lah')

    def test_nmr_str2nef_deposit_check_2lci(self):
        self.__test_nmr_str2nef_deposit_check('2lci')

    def test_nmr_str2nef_deposit_check_2ln3(self):
        self.__test_nmr_str2nef_deposit_check('2ln3')

    def test_nmr_str2nef_deposit_check_2loj(self):
        self.__test_nmr_str2nef_deposit_check('2loj')

    def test_nmr_str2nef_deposit_check_2ltl(self):
        self.__test_nmr_str2nef_deposit_check('2ltl')

    def test_nmr_str2nef_deposit_check_2ltm(self):
        self.__test_nmr_str2nef_deposit_check('2ltm')

    def test_nmr_str2nef_deposit_check_2m2e(self):
        self.__test_nmr_str2nef_deposit_check('2m2e')

    def test_nmr_str2nef_deposit_check_2m5o(self):
        self.__test_nmr_str2nef_deposit_check('2m5o')
