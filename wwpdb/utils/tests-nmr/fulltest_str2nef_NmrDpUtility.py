...
class TestNmrDpUtility(unittest.TestCase):
    ...
    def test_nmr_str2nef_release_check_1nk2(self):
        self.__test_nmr_str2nef_release_check('1nk2')

    def test_nmr_str2nef_release_check_2kko(self):
        self.__test_nmr_str2nef_release_check('2kko')

    def test_nmr_str2nef_release_check_2mqq(self):
        self.__test_nmr_str2nef_release_check('2mqq')

    def test_nmr_str2nef_release_check_2mtv(self):
        self.__test_nmr_str2nef_release_check('2mtv')

    def test_nmr_str2nef_release_check_2l9r(self):
        self.__test_nmr_str2nef_release_check('2l9r')

    def test_nmr_str2nef_release_check_2la6(self):
        self.__test_nmr_str2nef_release_check('2la6')

    def test_nmr_str2nef_release_check_2lah(self):
        self.__test_nmr_str2nef_release_check('2lah')

    def test_nmr_str2nef_release_check_2lci(self):
        self.__test_nmr_str2nef_release_check('2lci')

    def test_nmr_str2nef_release_check_2ln3(self):
        self.__test_nmr_str2nef_release_check('2ln3')

    def test_nmr_str2nef_release_check_2loj(self):
        self.__test_nmr_str2nef_release_check('2loj')

    def test_nmr_str2nef_release_check_2ltl(self):
        self.__test_nmr_str2nef_release_check('2ltl')

    def test_nmr_str2nef_release_check_2ltm(self):
        self.__test_nmr_str2nef_release_check('2ltm')

    def test_nmr_str2nef_release_check_2m2e(self):
        self.__test_nmr_str2nef_release_check('2m2e')

    def test_nmr_str2nef_release_check_2m5o(self):
        self.__test_nmr_str2nef_release_check('2m5o')
