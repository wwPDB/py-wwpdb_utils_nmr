...
class TestBMRBChemShiftStat(unittest.TestCase):
    ...
    def test_bb_atoms(self):
        self.assertEqual(self.bmrb_cs_stat.getBackBoneAtoms('GLY'),
                         ['C', 'CA', 'H', 'HA2', 'HA3', 'N'])
        self.assertEqual(self.bmrb_cs_stat.getBackBoneAtoms('PRO'),
                         ['C', 'CA', 'HA', 'N'])
        self.assertEqual(self.bmrb_cs_stat.getBackBoneAtoms('ALA'),
                         ['C', 'CA', 'H', 'HA', 'N'])
        self.assertEqual(self.bmrb_cs_stat.getBackBoneAtoms('CYS'),
                         ['C', 'CA', 'H', 'HA', 'N'])
        self.assertEqual(self.bmrb_cs_stat.getBackBoneAtoms('PTR'),
                         ['C', 'CA', 'H', 'HA', 'N'])
        self.assertEqual(self.bmrb_cs_stat.getBackBoneAtoms('PTR', polypeptide_like=True),
                         ['C', 'CA', 'H', 'HA', 'N'])
    ...
    def test_arom_atoms(self):
        ...
        self.assertEqual(self.bmrb_cs_stat.getAromaticAtoms('PRO'),
                         [])
        self.assertEqual(self.bmrb_cs_stat.getAromaticAtoms('HIS'),
                         ['CD2', 'CE1', 'CG', 'HD1', 'HD2', 'HE1', 'HE2', 'ND1', 'NE2'])
        self.assertEqual(self.bmrb_cs_stat.getAromaticAtoms('PHE'),
                         ['CD1', 'CD2', 'CE1', 'CE2', 'CG', 'CZ', 'HD1', 'HD2', 'HE1', 'HE2', 'HZ'])
        self.assertEqual(self.bmrb_cs_stat.getAromaticAtoms('TYR'),
                         ['CD1', 'CD2', 'CE1', 'CE2', 'CG', 'CZ', 'HD1', 'HD2', 'HE1', 'HE2'])
        self.assertEqual(self.bmrb_cs_stat.getAromaticAtoms('TRP'),
                         ['CD1', 'CD2', 'CE2', 'CE3', 'CG', 'CH2', 'CZ2', 'CZ3', 'HD1', 'HE1', 'HE3', 'HH2', 'HZ2', 'HZ3', 'NE1'])
        self.assertEqual(self.bmrb_cs_stat.getAromaticAtoms('PTR'),
                         ['CD1', 'CD2', 'CE1', 'CE2', 'HD1', 'HD2', 'HE1', 'HE2', 'CG', 'CZ'])
        self.assertEqual(self.bmrb_cs_stat.getAromaticAtoms('DA'),
                         ['C2', 'C4', 'C5', 'C6', 'C8', 'H2', 'H8', 'N1', 'N3', 'N7', 'N9'])
        self.assertEqual(self.bmrb_cs_stat.getAromaticAtoms('A'),
                         ['C2', 'C4', 'C5', 'C6', 'C8', 'H2', 'H8', 'N1', 'N3', 'N7', 'N9'])
        self.assertEqual(self.bmrb_cs_stat.getAromaticAtoms('5MC'),
                         [])

    def test_methyl_atoms(self):
        self.assertEqual(self.bmrb_cs_stat.getMethylAtoms('ALA'),
                         ['CB', 'HB1', 'HB2', 'HB3'])
        self.assertEqual(self.bmrb_cs_stat.getMethylAtoms('CYS'),
                         [])
        self.assertEqual(self.bmrb_cs_stat.getMethylAtoms('THR'),
                         ['CG2', 'HG21', 'HG22', 'HG23'])
        self.assertEqual(self.bmrb_cs_stat.getMethylAtoms('ILE'),
                         ['CG2', 'HG21', 'HG22', 'HG23', 'CD1', 'HD11', 'HD12', 'HD13'])
        self.assertEqual(self.bmrb_cs_stat.getMethylAtoms('VAL'),
                         ['CG1', 'HG11', 'HG12', 'HG13', 'CG2', 'HG21', 'HG22', 'HG23'])
        self.assertEqual(self.bmrb_cs_stat.getMethylAtoms('LEU'),
                         ['CD1', 'HD11', 'HD12', 'HD13', 'CD2', 'HD21', 'HD22', 'HD23'])
        self.assertEqual(self.bmrb_cs_stat.getMethylAtoms('DT'),
                         ['C7', 'H71', 'H72', 'H73'])
        self.assertEqual(self.bmrb_cs_stat.getRepMethylProtons('ALA'),
                         ['HB1'])
        self.assertEqual(self.bmrb_cs_stat.getNonRepMethylProtons('ALA'),
                         ['HB2', 'HB3'])
        self.assertEqual(self.bmrb_cs_stat.getMethylAtoms('HEM'),
                         ['CMA', 'HMA', 'HMAA', 'HMAB', 'CMB', 'HMB', 'HMBA', 'HMBB', 'CMC', 'HMC', 'HMCA', 'HMCB',
                          'CMD', 'HMD', 'HMDA', 'HMDB'])
        self.assertEqual(self.bmrb_cs_stat.getRepMethylProtons('HEM'),
                         ['HMA', 'HMB', 'HMC', 'HMD'])
        self.assertEqual(self.bmrb_cs_stat.getNonRepMethylProtons('HEM'),
                         ['HMAA', 'HMAB', 'HMBA', 'HMBB', 'HMCA', 'HMCB', 'HMDA', 'HMDB'])
        self.assertEqual(self.bmrb_cs_stat.getMethylAtoms('HEB'),
                         ['CMA', 'HMA1', 'HMA2', 'HMA3', 'CMB', 'HMB1', 'HMB2', 'HMB3', 'CBB', 'HBB1', 'HBB2', 'HBB3',
                          'CMC', 'HMC1', 'HMC2', 'HMC3', 'CMD', 'HMD1', 'HMD2', 'HMD3'])
        self.assertEqual(self.bmrb_cs_stat.getRepMethylProtons('HEB'),
                         ['HMA1', 'HMB1', 'HBB1', 'HMC1', 'HMD1'])
        self.assertEqual(self.bmrb_cs_stat.getNonRepMethylProtons('HEB'),
                         ['HMA2', 'HMA3', 'HMB2', 'HMB3', 'HBB2', 'HBB3', 'HMC2', 'HMC3', 'HMD2', 'HMD3'])
        self.assertEqual(self.bmrb_cs_stat.getMethylAtoms('HEC'),
                         ['CMA', 'HMA1', 'HMA2', 'HMA3', 'CMB', 'HMB1', 'HMB2', 'HMB3', 'CBB', 'HBB1', 'HBB2', 'HBB3',
                          'CMC', 'HMC1', 'HMC2', 'HMC3', 'CBC', 'HBC1', 'HBC2', 'HBC3', 'CMD', 'HMD1', 'HMD2', 'HMD3'])
        self.assertEqual(self.bmrb_cs_stat.getRepMethylProtons('HEC'),
                         ['HMA1', 'HMB1', 'HBB1', 'HMC1', 'HBC1', 'HMD1'])
        self.assertEqual(self.bmrb_cs_stat.getNonRepMethylProtons('HEC'),
                         ['HMA2', 'HMA3', 'HMB2', 'HMB3', 'HBB2', 'HBB3', 'HMC2', 'HMC3', 'HBC2', 'HBC3', 'HMD2', 'HMD3'])
        self.assertEqual(self.bmrb_cs_stat.getRepMethylProtons('L94'),
                         ['H171', 'H474', 'H181', 'H484'])
        self.assertEqual(self.bmrb_cs_stat.getMethylAtoms('MET'),
                         ['CE', 'HE1', 'HE2', 'HE3'])

    def test_sc_atoms(self):
        self.assertEqual(self.bmrb_cs_stat.getSideChainAtoms('GLY'),
                         [])
        self.assertEqual(self.bmrb_cs_stat.getSideChainAtoms('ALA'),
                         ['CB', 'HB1', 'HB2', 'HB3'])
        self.assertEqual(self.bmrb_cs_stat.getSideChainAtoms('CYS'),
                         ['CB', 'HB2', 'HB3', 'HG'])
        self.assertEqual(set(self.bmrb_cs_stat.getSideChainAtoms('THR')),
                         {'CB', 'CG2', 'HB', 'HG1', 'HG21', 'HG22', 'HG23'})
        self.assertEqual(set(self.bmrb_cs_stat.getSideChainAtoms('THR', excl_minor_atom=True)),
                         {'CB', 'CG2', 'HB', 'HG21', 'HG22', 'HG23'})
        self.assertEqual(self.bmrb_cs_stat.getSideChainAtoms('PRO'),
                         ['CB', 'CD', 'CG', 'HB2', 'HB3', 'HD2', 'HD3', 'HG2', 'HG3'])
        self.assertEqual(self.bmrb_cs_stat.getSideChainAtoms('ARG'),
                         ['CB', 'CD', 'CG', 'CZ', 'HB2', 'HB3', 'HD2', 'HD3',
        ...
        self.assertEqual(self.bmrb_cs_stat.getSideChainAtoms('A'),
                         ['C2', 'C4', 'C5', 'C6', 'C8', 'H2', 'H61', 'H62', 'H8', 'N1', 'N3', 'N6', 'N7', 'N9'])
        self.assertEqual(self.bmrb_cs_stat.getSideChainAtoms('5MC', polynucleotide_like=True),
                         ['HN41', 'HN42', 'H6', 'HM51', 'HM52', 'HM53', 'N1', 'C2', 'N3', 'C4', 'N4', 'C5', 'C6', 'CM5', 'HOP2', 'HOP3'])
