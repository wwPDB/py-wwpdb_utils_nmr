...
class TestNmrDpReport(unittest.TestCase):
    ...
    def test_report_generation(self):
        ...
        answer = json.dumps(json.loads('{"corrected_warning": null, "error": {"anomalous_data": null, "content_mismatch": null, "duplicated_index": null, "format_issue": ["foo"], "internal_error": null, "invalid_ambiguity_code": null, "invalid_atom_nomenclature": null, "invalid_atom_type": null, "invalid_data": null, "invalid_isotope_number": null, "missing_mandatory_content": null, "missing_mandatory_item": null, "missing_data": null, "multiple_data": null, "sequence_mismatch": null, "total": 1}, "information": {"cyclic_polymer": false, "chain_assignments": {"model_poly_seq_vs_nmr_poly_seq": "foo", "nmr_poly_seq_vs_model_poly_seq": null}, "diamagnetic": true, "disulfide_bond": false, "input_sources": [{"content_subtype": {"chem_shift": 1, "dist_restraint": 2, "poly_seq": 1}, "content_type": "nmr-data-nef", "disulfide_bond": null, "file_name": null, "file_type": "nef", "non_standard_residue": null, "other_bond": null, "polymer_sequence": null, "polymer_sequence_in_loop": null, "stats_of_exptl_data": null}, {"content_subtype": {"coordinate": 1, "poly_seq": 1}, "content_type": "model", "disulfide_bond": null, "file_name": null, "file_type": "pdbx", "non_standard_residue": null, "other_bond": null, "polymer_sequence": null, "polymer_sequence_in_loop": null, "stats_of_exptl_data": null}], "sequence_alignments": {"model_poly_seq_vs_coordinate": null, "model_poly_seq_vs_nmr_poly_seq": "foo", "nmr_poly_seq_vs_model_poly_seq": null, "nmr_poly_seq_vs_chem_shift": null, "nmr_poly_seq_vs_dihed_restraint": null, "nmr_poly_seq_vs_dist_restraint": null, "nmr_poly_seq_vs_rdc_restraint": null, "nmr_poly_seq_vs_spectral_peak": null}, "other_bond": false, "status": "Error"}, "warning": {"ambiguity_code_mismatch": null, "anomalous_bond_length": null, "anomalous_chemical_shift": null, "anomalous_data": null, "atom_nomenclature_mismatch": null, "auth_atom_nomenclature_mismatch": null, "ccd_mismatch": null, "concatenated_sequence": null, "conflicted_data": null, "corrected_format_issue": null, "disordered_index": null, "encouragement": null, "enum_mismatch": null, "enum_mismatch_ignorable": null, "inconsistent_data": null, "insufficient_data": null, "missing_content": ["foo"], "missing_data": null, "missing_saveframe": null, "not_superimposed_model": null, "redundant_data": null, "remarkable_data": null, "sequence_mismatch": null, "skipped_loop_category": null, "skipped_saveframe_category": null, "total": 1, "unusual_chemical_shift": null, "unusual_data": null}}'), sort_keys=True)
