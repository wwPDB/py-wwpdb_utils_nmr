##
# File: test_daother_7681.py
# Date:  21-Feb-2022  M. Yokochi
#
# Updates:
##
import unittest
...
class TestNmrDpUtility(unittest.TestCase):
    ...
    def __test_nmr_nef_consistency(self, entry_id):
        ...
        self.utility.addInput(name='coordinate_file_path',
                              value=self.data_dir_path + self.data_file_path[entry_id]['cif'],
                              type='file')
        ...
        self.utility.addInput(name='cmpl_missing_data', value=True, type='param')
    ...
    def __test_nmr_nef2str_deposit(self, entry_id):
        ...
        self.utility.addOutput(name='nmr-star_file_path',
                               value=self.data_dir_path + entry_id + '-nef2str.str',
                               type='file')
