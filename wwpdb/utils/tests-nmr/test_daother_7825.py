##
# File: test_daother_7825.py
# Date:  01-Jun-2022  M. Yokochi
#
# Updates:
#
import unittest
...
class TestNmrDpUtility(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data_dir_path = os.path.join(here, 'mock-data-daother-7825/')
        self.res_file_type = {
            'daother-7825': 'nm-res-bio'
        }
        self.cs_file_path = {
            'daother-7825': ['2lyw_cs.str']
        }
        self.mr_file_path = {
            'daother-7825': ['2lyw-trimmed.mr']
        }
        self.model_file_path = {
            'daother-7825': '2lyw.cif'
        }
    ...
    def test_nmr_cs_str_consistency_check_daother_7825(self):
        self.__test_nmr_cs_str_consistency('daother-7825')
