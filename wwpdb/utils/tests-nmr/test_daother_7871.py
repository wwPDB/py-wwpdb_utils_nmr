...
class TestNmrDpUtility(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data_dir_path = os.path.join(here, 'mock-data-daother-7871/')
        self.res_file_type = {
            'daother-7871': ['nm-res-xpl', 'nm-res-xpl', 'nm-res-xpl', 'nm-res-xpl']
        }
        self.cs_file_path = {
            'daother-7871': ['wsh2090_shifts.str']
        }
        self.mr_file_path = {
            'daother-7871': ['wsh2090_ambig_rev.tbl', 'wsh2090_dihedrals.tbl', 'wsh2090_hbonds_v1.tbl', 'wsh2090_unambig_rev.tbl']
        }
        self.model_file_path = {
            'daother-7871': 'D_800473_model_P1.cif.V3'
        }
    ...
    def test_nmr_cs_str_consistency_check_daother_7871(self):
        self.__test_nmr_cs_str_consistency('daother-7871')
