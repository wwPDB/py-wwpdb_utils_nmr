...
class TestNmrDpUtility(unittest.TestCase):
    ...
    def __test_nmr_nef_consistency(self, entry_id):
        ...
        with open(self.data_dir_path + entry_id + '-disulfide-bond-nef-consistency-log.json', 'r', encoding='utf-8') as file:
    ...
    def __test_nmr_nef2str_deposit(self, entry_id):
        ...
        with open(self.data_dir_path + entry_id + '-disulfide-bond-nef2str-str-deposit-log.json', 'r', encoding='utf-8') as file:
            report = json.loads(file.read())
    ...
    def __test_nmr_str_consistency(self, entry_id):
        ...
        with open(self.data_dir_path + entry_id + '-disulfide-bond-str2nef-consistency-log.json', 'r', encoding='utf-8') as file:
            report = json.loads(file.read())
    ...
    def __test_nmr_str2nef_release(self, entry_id):
        ...
        with open(self.data_dir_path + entry_id + '-disulfide-bond-str2nef-nef-release-log.json', 'r', encoding='utf-8') as file:
            report = json.loads(file.read())
