##
# File: test_ulocked_model.py
# Date:  09-May-2020  M. Yokochi
#
# Updates:
##
import json
...
class TestNmrDpUtility(unittest.TestCase):
    ...
    def __test_nmr_nef_consistency(self, entry_id):
        ...
        self.utility.setLog(self.data_dir_path + entry_id + '-unlocked-nef-consistency-log.json')

        self.utility.op('nmr-nef-consistency-check')

        with open(self.data_dir_path + entry_id + '-unlocked-nef-consistency-log.json', 'r', encoding='utf-8') as file:
    ...
    def __test_nmr_nef2str_deposit(self, entry_id):  # pylint: disable=unused-private-member
        ...
        with open(self.data_dir_path + entry_id + '-unlocked-nef2str-str-deposit-log.json', 'r', encoding='utf-8') as file:
            report = json.loads(file.read())
